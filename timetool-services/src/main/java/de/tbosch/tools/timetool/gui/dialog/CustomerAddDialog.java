...
public class CustomerAddDialog extends JDialog {
	 ...
	 */
	public CustomerAddDialog(GuiController guiController, Dialog dialog) {
		super(dialog, true);
		this.guiController = guiController;
		setTitle(MessageHelper.getMessage("frame.addCustomer.title"));
	...
	private void init() {
		...
		JLabel labelName = new JLabel(MessageHelper.getMessage("frame.addCustomer.labelName"));
