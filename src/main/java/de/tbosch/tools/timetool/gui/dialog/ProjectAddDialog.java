 ...
 * @author Thomas Bosch
 */
public class ProjectAddDialog extends JDialog {
	 ...
	 */
	public ProjectAddDialog(GuiController guiController, Dialog dialog) {
		super(dialog, true);
		this.guiController = guiController;
		setTitle(MessageHelper.getMessage("frame.addProject.title"));
	...
	private void init() {
		...
		JLabel labelName = new JLabel(MessageHelper.getMessage("frame.addProject.labelName"));
		...
		constraints = new GridBagConstraints();
		JLabel labelCustomer = new JLabel(MessageHelper.getMessage("frame.addProject.labelCustomer"));
		constraints.insets = new Insets(5, 5, 5, 5);
		constraints.gridy = 1;
		constraints.anchor = GridBagConstraints.EAST;
		...
		constraints = new GridBagConstraints();
		JButton addCustomerButton = new JButton(MessageHelper.getMessage("frame.addProject.buttonManageCustomer"));
